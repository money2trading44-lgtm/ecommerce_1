...
from .models import Category, Product, RepairRequest, Cart, CartItem, Order
...
class ProductAdmin(admin.ModelAdmin):
    list_display = ['name','price','category','product_type','on_sale','stock']
    list_filter = ['category','product_type','on_sale']
